 ...
 * Returns the same shape as the Gemini response so it can be used as
 * a direct fallback with zero downstream changes.
 */
...
/**
 * rulesBasedAnalysis(data) → analysis object
 * @param {object} data — complaint payload (description, category, imagePath, geoLat, voiceTranscript …)
 */
